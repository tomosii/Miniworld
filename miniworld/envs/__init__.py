...
gym.register(
    id="MiniWorld-Custom-v0",
    entry_point="miniworld.envs.custom:Custom",
)

gym.register(
    id="MiniWorld-Custom3D-v0",
    entry_point="miniworld.envs.custom_3d:Custom3D",
)

gym.register(
    id="MiniWorld-CustomNinerooms-v0",
    entry_point="miniworld.envs.custom_ninerooms:CustomNinerooms",
)

gym.register(
    id="MiniWorld-SerialNinerooms-v0",
    entry_point="miniworld.envs.serial_ninerooms:SerialNinerooms",
)
