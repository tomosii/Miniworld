...
class Custom3D(MiniWorldEnv, utils.EzPickle):
    """
    ## Description
    ...
    def _gen_world(self):
        ...
        self.connect_rooms(room0, room1, min_z=-6.5, max_z=-5.5)
        self.connect_rooms(room1, room2, min_z=-6.5, max_z=-5.5)

        self.connect_rooms(room3, room4, min_z=-0.5, max_z=0.5)
        self.connect_rooms(room4, room5, min_z=-0.5, max_z=0.5)

        self.connect_rooms(room6, room7, min_z=5.5, max_z=6.5)
        self.connect_rooms(room7, room8, min_z=5.5, max_z=6.5)

        self.connect_rooms(room0, room3, min_x=-6.5, max_x=-5.5)
        self.connect_rooms(room3, room6, min_x=-6.5, max_x=-5.5)

        self.connect_rooms(room1, room4, min_x=-0.5, max_x=0.5)
        self.connect_rooms(room4, room7, min_x=-0.5, max_x=0.5)

        self.connect_rooms(room2, room5, min_x=5.5, max_x=6.5)
        self.connect_rooms(room5, room8, min_x=5.5, max_x=6.5)
